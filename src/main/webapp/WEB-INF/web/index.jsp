						...
						<div id="pagesb" class="accordion-body  collapse"
							...
							<div class="accordion-inner">
								<ul class="nav nav-list">
									<li><a
										href="javascript:changeContent('viewBulletin.action');"><i
											class="icon-th-list"></i>查看公告</a></li>
									<li><a
										href="javascript:changeContent('bulletinManage.action');"><i
											class="icon-th-list"></i>公告管理</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div id="dashboardsb" class="accordion-body collapse"
							...
							<div class="accordion-inner">
								<ul class="nav nav-list">
									...
									<li><a
										href="javascript:changeContent('role/roleManage.action')"><i
											class="icon-th-list"></i> 角色管理</a></li>
									<li><a
										href="javascript:changeContent('permission/permissionManage.action')"><i
											class="icon-th-list"></i> 权限管理</a></li>
								</ul>
							</div>
						</div>
					</div>
